/**
 * Hoisted copy of `packages/templates/src/m0saic/theming/v1/theme-tokens.ts`
 * (the original stays for the frozen first-party templates) — the presets the
 * onboarding-cover kit resolves its canonical dark tokens from. Unchanged
 * apart from this note; `@m0saic/template-utils`'s own `theming/` folder is
 * the channel resolver (publish/read/apply) and carries no presets.
 *
 * ============================================================================
