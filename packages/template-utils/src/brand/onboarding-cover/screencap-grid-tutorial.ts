 ...
 * screencap-grid-tutorial.ts` (the original stays for the frozen first-party
 * templates); unchanged apart from this note.
 *
 ...
 * web-safe pattern (candidate note, 2026-08-25): no node:path import, asar
