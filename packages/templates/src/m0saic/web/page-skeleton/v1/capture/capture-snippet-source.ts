// Embedded source handoff mirrored from capture-snippet.js.
// The colocated drift test requires byte-for-byte equality.
export const PAGE_SKELETON_CAPTURE_SNIPPET = [
  "(function () {",
  "  \"use strict\";",
  "",
