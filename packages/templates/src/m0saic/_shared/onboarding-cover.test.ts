/**
 * Locks for the hoisted mosaic-branding cover kit.
 *
 * The theme contract lives in `.ai/proposed-plans/mosaic-branding-covers.md`;
 * these specs pin the assembler's shape: chat pane copy lands in sources,
...
describe("inlineHeroDoc", () => {
  it("inlines a rendered doc flat — m0 + sources, no child ref", () => {
    const doc = build(1920, 1080);
    const { inlineHeroDoc } = require("./onboarding-cover");
